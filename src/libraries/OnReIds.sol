...
library OnReIds {
    ...
    function pricerId(address onReToken, OnReTypes.PricingDenomination denomination) internal pure returns (bytes32) {
    ...
    function configurableVaultId(OnReTypes.ConfigurableVaultKind kind, uint64 vaultId_)
        internal
        pure
        returns (bytes32)
    {
    ...
    function offerConfigId(address tokenIn, address tokenOut, OnReTypes.OfferFlow flow)
        internal
        pure
        returns (bytes32)
    {
